...
- [~] Bundled pattern library in `patterns/`, listed and placeable the way the rule library is (F-027, added 2026-09-15). Machinery done 2026-09-21 with four patterns bundled, each verified by running it; the Brian's Brain, cyclic, hexagonal and 3D entries of F-027's set still have to be constructed
