...
The remaining steps: the codegen backend and its shader, `Simulation` and the session format, then a multi-field fixture in the equivalence suite and a way to author one.
