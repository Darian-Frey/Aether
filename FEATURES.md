...
The remaining step: a multi-field fixture in the equivalence suite, and a way to author one in Lua. `headless compare` still compares states only, which is part of that step.
